...
| `monthsCalendarProps` | [`DaysCalendarProps`](#months-calendar-props)                                                                                                                                              | —              | An object containing props that customize the rendering and behavior of the months calendar view. |
| `yearsCalendarProps`  | [`DaysCalendarProps`](#years-calendar-props)                                                                                                                                               | —              | An object containing props that customize the rendering and behavior of the years calendar view.  |
